...
This repository provides the analysis code (`code_for_paper.ipynb`) reproducing the machine learning results in the paper. We apply PCA, Random Forest classification, and Random Forest regression to DFT-simulated carbon K-edge XANES spectra to predict local chemical environments boron- and nitrogen-doped graphene.
